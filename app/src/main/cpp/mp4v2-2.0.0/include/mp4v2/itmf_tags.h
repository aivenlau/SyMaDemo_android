 ...
 *  nullptr indicates its corresponding atom does not exist. Thus, one must
 *  always check if the pointer is non-nullptr before attempting to extract
 *  its value.
 *
 ...
 *  the read-only structure. Setting the value ptr to nullptr will effectively
 ...
 *  pointer is a <b>non-nullptr</b> value. The actual data is backed by a hidden
