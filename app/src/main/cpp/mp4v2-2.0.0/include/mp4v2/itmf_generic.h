 ...
 *  also have a valueSize field. If value is nullptr then set valueSize=0.
...
{
    MP4ItmfData* elements; /**< flat array. nullptr when size is zero. */
...
typedef struct MP4ItmfItem_s
{
    ...
    char*           code;     /**< four-char code identifing atom type. nullptr-terminated. */
    char*           mean;     /**< may be nullptr. UTF-8 meaning. nullptr-terminated. */
    char*           name;     /**< may be nullptr. UTF-8 name. nullptr-terminated. */
...
{
    MP4ItmfItem* elements; /**< flat array. nullptr when size is zero. */
    uint32_t     size;     /**< number of elements. */
} MP4ItmfItemList;

/** Allocate an item on the heap.
 *  @param code four-char code identifying atom type. nullptr-terminated.
 ...
 *  @return On succes, list of items, which must be free'd. On failure, nullptr.
 */
 ...
 *  @param hFile handle of file to operate on.
 *  @param meaning UTF-8 meaning. nullptr-terminated.
 *  @param name may be nullptr. UTF-8 name. nullptr-terminated.
 *  @return On succes, list of items, which must be free'd. On failure, nullptr.
 */
MP4V2_EXPORT MP4ItmfItemList*
