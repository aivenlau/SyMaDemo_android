...
bool MP4GetHintTrackRtpPayload(
    ...
    char**        ppPayloadName DEFAULT(nullptr),
    uint8_t*      pPayloadNumber DEFAULT(nullptr),
    uint16_t*     pMaxPayloadSize DEFAULT(nullptr),
    char**        ppEncodingParams DEFAULT(nullptr) );
...
bool MP4SetHintTrackRtpPayload(
    ...
    const char *  encode_params DEFAULT(nullptr),
...
bool MP4ReadRtpHint(
    ...
    uint16_t*     pNumPackets DEFAULT(nullptr) );
